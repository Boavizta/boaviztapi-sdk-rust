...
pub async fn external_hdd_impact_v1_peripheral_external_hdd_get(configuration: &configuration::Configuration, archetype: Option<&str>, verbose: Option<bool>, duration: Option<f64>, criteria: Option<Vec<String>>) -> Result<serde_json::Value, Error<ExternalHddImpactV1PeripheralExternalHddGetError>> {
    let local_var_configuration = configuration;
...
/// # ✔ Peripheral impacts ### Features  👄 Verbose  🔃 Auto-complete  🔨 Embedded  The impacts values are fix🔌 Usage  * ⏺️  Given  * 📋 Archetype  ⏬ Allocation
pub async fn external_ssd_impact_v1_peripheral_external_ssd_get(configuration: &configuration::Configuration, archetype: Option<&str>, verbose: Option<bool>, duration: Option<f64>, criteria: Option<Vec<String>>) -> Result<serde_json::Value, Error<ExternalSsdImpactV1PeripheralExternalSsdGetError>> {
    let local_var_configuration = configuration;
...
/// # ✔ Peripheral impacts ### Features  👄 Verbose  🔃 Auto-complete  🔨 Embedded  The impacts values are fix🔌 Usage  * ⏺️  Given  * 📋 Archetype  ⏬ Allocation
pub async fn monitor_impact_v1_peripheral_monitor_get(configuration: &configuration::Configuration, archetype: Option<&str>, verbose: Option<bool>, duration: Option<f64>, criteria: Option<Vec<String>>) -> Result<serde_json::Value, Error<MonitorImpactV1PeripheralMonitorGetError>> {
    let local_var_configuration = configuration;
...
/// # ✔ Peripheral impacts ### Features  👄 Verbose  🔃 Auto-complete  🔨 Embedded  The impacts values are fix🔌 Usage  * ⏺️  Given  * 📋 Archetype  ⏬ Allocation
pub async fn monitor_impact_v1_peripheral_monitor_post(configuration: &configuration::Configuration, verbose: Option<bool>, duration: Option<f64>, archetype: Option<&str>, criteria: Option<Vec<String>>, monitor: Option<models::Monitor>) -> Result<serde_json::Value, Error<MonitorImpactV1PeripheralMonitorPostError>> {
    let local_var_configuration = configuration;
...
/// # ✔ Peripheral impacts ### Features  👄 Verbose  🔃 Auto-complete  🔨 Embedded  The impacts values are fix🔌 Usage  * ⏺️  Given  * 📋 Archetype  ⏬ Allocation
pub async fn usb_stick_impact_v1_peripheral_usb_stick_get(configuration: &configuration::Configuration, archetype: Option<&str>, verbose: Option<bool>, duration: Option<f64>, criteria: Option<Vec<String>>) -> Result<serde_json::Value, Error<UsbStickImpactV1PeripheralUsbStickGetError>> {
    let local_var_configuration = configuration;
...
/// # ✔ Peripheral impacts ### Features  👄 Verbose  🔃 Auto-complete  🔨 Embedded  The impacts values are fix🔌 Usage  * ⏺️  Given  * 📋 Archetype  ⏬ Allocation
pub async fn usb_stick_impact_v1_peripheral_usb_stick_post(configuration: &configuration::Configuration, verbose: Option<bool>, duration: Option<f64>, archetype: Option<&str>, criteria: Option<Vec<String>>, usb_stick: Option<models::UsbStick>) -> Result<serde_json::Value, Error<UsbStickImpactV1PeripheralUsbStickPostError>> {
    let local_var_configuration = configuration;
