...
pub async fn server_impact_from_configuration_v1_server_post(configuration: &configuration::Configuration, verbose: Option<bool>, duration: Option<f64>, archetype: Option<&str>, criteria: Option<Vec<String>>, server: Option<models::Server>) -> Result<serde_json::Value, Error<ServerImpactFromConfigurationV1ServerPostError>> {
    let local_var_configuration = configuration;
...
pub async fn server_impact_from_model_v1_server_get(configuration: &configuration::Configuration, archetype: Option<&str>, verbose: Option<bool>, duration: Option<f64>, criteria: Option<Vec<String>>) -> Result<serde_json::Value, Error<ServerImpactFromModelV1ServerGetError>> {
    let local_var_configuration = configuration;
