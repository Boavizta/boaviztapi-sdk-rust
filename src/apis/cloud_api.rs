...
pub async fn instance_cloud_impact_v1_cloud_instance_get(configuration: &configuration::Configuration, provider: Option<&str>, instance_type: Option<&str>, verbose: Option<bool>, duration: Option<f64>, criteria: Option<Vec<String>>) -> Result<serde_json::Value, Error<InstanceCloudImpactV1CloudInstanceGetError>> {
    let local_var_configuration = configuration;
...
/// # ✔ ️Cloud instance impacts from provider, instance type and usage  Retrieve the impacts of a given Cloud instance and usage.  ### Features  📋 Provider   Name of the cloud provider. You can retrieve the [list here](#/cloud_instance/server_get_all_cloud_providers).  📋 Instance type   Name of the chosen instance. You can retrieve the [list here](#/cloud/server_get_archetype_name_v1_cloud_all_aws_instances_get).  👄 Verbose  🔨 Embedded  🔌 Usage   * 📈 Modeled  📋 Archetype : The configuration is set by the API, only usage is given by the user  ⏬ Allocation
pub async fn instance_cloud_impact_v1_cloud_instance_post(configuration: &configuration::Configuration, verbose: Option<bool>, duration: Option<f64>, criteria: Option<Vec<String>>, cloud: Option<models::Cloud>) -> Result<serde_json::Value, Error<InstanceCloudImpactV1CloudInstancePostError>> {
    let local_var_configuration = configuration;
