...
pub async fn cpu_consumption_profile_v1_consumption_profile_cpu_post(configuration: &configuration::Configuration, verbose: Option<bool>, consumption_profile_cpu: Option<models::ConsumptionProfileCpu>) -> Result<serde_json::Value, Error<CpuConsumptionProfileV1ConsumptionProfileCpuPostError>> {
