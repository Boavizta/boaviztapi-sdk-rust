...
pub struct UsageCloud {
    #[serde(rename = "use_time_ratio", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub use_time_ratio: Option<Option<f64>>,
    #[serde(rename = "hours_life_time", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub hours_life_time: Option<Option<f64>>,
    #[serde(rename = "avg_power", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub avg_power: Option<Option<f64>>,
   ...
   pub time_workload: Option<f64>,
    #[serde(rename = "usage_location", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub usage_location: Option<Option<String>>,
    #[serde(rename = "elec_factors", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub elec_factors: Option<Option<Box<models::ElecFactors>>>,
    #[serde(rename = "other_consumption_ratio", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub other_consumption_ratio: Option<Option<f64>>,
    #[serde(rename = "instance_per_server", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub instance_per_server: Option<Option<i32>>,
}
