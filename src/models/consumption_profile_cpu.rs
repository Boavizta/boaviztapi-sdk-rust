...
/// ConsumptionProfileCpu : BaseDTO is simple BaseModel object



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ConsumptionProfileCpu {
    #[serde(rename = "workload", skip_serializing_if = "Option::is_none")]
    pub workload: Option<Vec<crate::models::WorkloadPower>>,
    #[serde(rename = "cpu", skip_serializing_if = "Option::is_none")]
    pub cpu: Option<Box<crate::models::Cpu>>,
}

impl ConsumptionProfileCpu {
    /// BaseDTO is simple BaseModel object
    pub fn new() -> ConsumptionProfileCpu {
