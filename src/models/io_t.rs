...
/// IoT : BaseDTO is simple BaseModel object



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IoT {
    #[serde(rename = "functional_blocks", skip_serializing_if = "Option::is_none")]
    pub functional_blocks: Option<Vec<crate::models::FunctionalBlock>>,
