...
pub struct IoT {
    #[serde(rename = "functional_blocks", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub functional_blocks: Option<Option<Vec<models::FunctionalBlock>>>,
