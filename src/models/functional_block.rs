...
/// FunctionalBlock : BaseDTO is simple BaseModel object
...
pub struct FunctionalBlock {
    ...
    #[serde(rename = "hsl_level", skip_serializing_if = "Option::is_none")]
    pub hsl_level: Option<String>,
