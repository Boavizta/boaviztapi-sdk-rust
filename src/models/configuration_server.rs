...
pub struct ConfigurationServer {
    ...
    pub cpu: Option<Option<Box<models::Cpu>>>,
    #[serde(rename = "ram", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub ram: Option<Option<Vec<models::Ram>>>,
    #[serde(rename = "disk", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub disk: Option<Option<Vec<models::Disk>>>,
    #[serde(rename = "power_supply", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub power_supply: Option<Option<Box<models::PowerSupply>>>,
}
