...
pub struct Cpu {
    ...
    #[serde(rename = "core_units", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub core_units: Option<Option<i32>>,
    #[serde(rename = "die_size", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub die_size: Option<Option<f64>>,
    #[serde(rename = "die_size_per_core", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub die_size_per_core: Option<Option<f64>>,
    ...
    #[serde(rename = "model_range", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub model_range: Option<Option<String>>,
    ...
    #[serde(rename = "tdp", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub tdp: Option<Option<i32>>,
}
